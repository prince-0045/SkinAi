...
export default function Profile() {
    ...
    const history = [
        { id: 1, date: '2025-11-04', type: 'Scan', result: 'Psoriasis', status: 'Detected' },
        { id: 2, date: '2025-10-28', type: 'Checkup', result: 'Improvement', status: 'Good' },
        { id: 3, date: '2025-10-15', type: 'Scan', result: 'Eczema', status: 'Detected' },
    ];
                        ...
                        {activeTab === 'security' && (
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <button className="text-medical-600 text-sm font-medium hover:bg-medical-50 px-3 py-2 rounded-lg -ml-3 transition">Change Password</button>
                                </div>
                            </div>
                        )}
                    </div>
